...
| dev-only 导航  | `devHub.mjs`、`devRoutes.mjs`、`devDocs.mjs`、`devTesting.mjs`、`devDataPreparation.mjs`、`devGovernance.mjs`、`devPrototypes.mjs`、`devCapabilityLedger.mjs` | `/__dev/*` 本地治理、文档、测试数据准备、原型和能力真源入口 |
