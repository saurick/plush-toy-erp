...
export const DEV_PROTOTYPE_ASSETS = Object.freeze([
  ...
  },
  {
    ...
    appliesTo:
      '客户、供应商、联系人、销售订单、采购、BOM、出货、库存、质检和财务等页面级新建 / 编辑表单可参照；item 区来源选择器入口和明细统计留在本样板，来源选择器本体、列顺序、生命周期动作说明和危险确认回到局部动作弹窗样板。',
  },
  {
    ...
    description:
      '覆盖单据补录、来源选择器、明细行、列顺序、生命周期动作说明和危险确认；来源选择器最多作为第二层，保留分页、已选摘要和清空已选，只选择来源不编辑本单字段，不承诺通用回收站。',
    appliesTo:
