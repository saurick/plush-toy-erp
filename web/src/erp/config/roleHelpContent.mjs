  ...
  },
  {
    ...
    priorities: [
      ...
      },
      {
        title: '跟进销售订单',
        description:
          '核对客户、产品规格、数量、单价、税费 / 运费条件和预计出货日期。',
    ...
    workflow: [
      ...
      '创建或更新销售订单，核对产品规格、数量、单价、计税方式、报价是否含运费和交期。',
      '提交订单后查看老板审批、工程资料和 PMC 评审进度。',
      '订单生效后继续跟进缺料、生产异常和实际出货结果。',
    ],
    completion:
      '订单号、客户、收货信息、数量、单价、货款、税额、总额和提交状态可查，审批事项已经生成；后续岗位完成评审后，必须回销售订单页面核对是否已生效，未生效时不得继续当作已批准订单使用。',
    handoff:
