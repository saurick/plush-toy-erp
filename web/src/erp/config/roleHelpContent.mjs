...
export const ROLE_HELP_GUIDES = Object.freeze([
  ...
  },
  {
    ...
    priorities: [
      {
        title: '维护客户资料',
        description: '先补齐交易主体、联系人和默认收货信息，再创建销售订单。',
      ...
      },
      {
        title: '跟进销售订单',
        description:
          '核对客户、产品规格、数量、单价、税费、报价运费和预计出货日期。',
    ...
    workflow: [
      '确认客户、联系人和默认收货信息完整；本单有变化时直接调整本单收货信息。',
      '创建或更新销售订单，核对产品规格、数量、单价、计税方式、报价是否含运费、另计报价运费和交期。',
      '提交订单后查看老板审批、工程资料和 PMC 评审进度。',
      '订单生效后继续跟进缺料、生产异常和实际出货结果。',
    ],
    completion:
      '订单号、客户、收货信息、数量、单价、货款、报价运费、税额、总额和提交状态可查，审批事项已经生成；后续岗位完成评审后，必须回销售订单页面核对是否已生效，未生效时不得继续当作已批准订单使用。',
    handoff:
  ...
  },
  {
    ...
    priorities: [
      {
        title: '核对供应商和材料',
        description:
          '确认供应商付款 / 开票默认值、材料规格和单位可以被采购单正确引用。',
        path: '/erp/master/partners/suppliers',
        actionLabel: '打开供应商与加工厂',
      },
      {
        title: '办理采购订单',
        description: '维护数量、单价、付款 / 开票条件、收货地址和到货日期。',
    ...
    completion:
      '采购订单、供应商、材料、数量、付款 / 开票条件、收货地址和到货日期可查，提交状态明确；到料后已形成可供品质和仓库核对的来源记录。',
    handoff:
  ...
  },
  {
    ...
    priorities: [
      ...
      },
      {
        title: '办理实际出货',
        description:
          '先确认放行和检验，再补齐收货、运输、包装和物流信息并完成发货。',
        path: '/erp/warehouse/shipments',
        actionLabel: '打开出货单',
      },
    ],
    workflow: [
      ...
      '出货前核对放行、检验、来源数量、收货信息、运输方式、包装和物流单号，确认发货后再检查库存变化。',
    ],
    completion:
    ...
    caution:
      '生产提交完工报告不等于成品已经入库；出货放行不等于已经出库，出货单实际运费也不等于已经形成应付或付款。',
  },
  {
    key: 'finance',
    label: '财务',
    headline:
      '先核对老板已审核的工程用料并生成采购单，再按真实业务结果办理收付款和对账。',
    ...
    workflow: [
      '在销售订单的材料汇总与审批中核对部位用料、实购数量、单价和交期；批准后按厂商生成采购订单。',
      '先核对来源单号、往来方、金额和业务状态。',
  ...
  },
  {
    ...
    label: '工程',
    headline:
      '从客户订单需求开始，建产品图样、按材料填写部位明细，再打样和提交用料审批。',
    priorities: [
      {
        title: '维护产品规格',
    ...
    workflow: [
      '先在销售订单的工程资料中查看客户需求，再建立产品、图样和规格。',
      '材料名称、厂商和料号色号、规格、单位只建一次；同料的各部位连续填写用量和损耗。',
      '打样确认后启用量产 BOM，在销售订单提交用料汇总，由老板审核、财务核价。',
      '生产负责人决定材料加工和车缝、手工的本厂或委外安排；工程资料变更须重新核对样品和用料。',
    ],
    completion:
