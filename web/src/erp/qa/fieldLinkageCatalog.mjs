...
export const FIELD_LINKAGE_FIELD_CATALOG = [
  ...
  {
    fieldKey: 'outsourcingSubject',
    fieldLabel: '委外加工主体',
    category: '源单主体与快照边界',
    risk: 'P0',
    docLabels: ['加工主体类型', '产品或材料'],
    requiredScenarioKeys: [
      'source_snapshot_retained',
      'source_change_clears_prefill',
      'master_record_selection_synced',
...
export const FIELD_LINKAGE_CASE_CATALOG = [
  ...
  {
    caseId: 'FL_outsourcing_subject_switch__clears_other_subject_and_snapshots',
    title: '委外加工主体切换时清空另一主体及其来源快照',
    fieldKeys: [
      'outsourcingSubject',
      'productMasterSelection',
      'accessoryMaterial',
    ],
    scenarioKey: 'source_change_clears_prefill',
    layer: 'web',
  ...
  {
    caseId: 'FL_outsourcing_subject_echo__uses_migrated_subject_type',
    title: '委外加工明细按正式主体类型回显产品或材料',
    fieldKeys: ['outsourcingSubject'],
    scenarioKey: 'source_snapshot_retained',
    layer: 'web',
    testFile: 'web/src/erp/utils/masterDataOrderView.test.mjs',
  },
  {
    caseId: 'FL_outsourcing_subject_payload__serializes_exactly_one_subject',
    title: '委外保存参数只序列化当前选中的一个加工主体',
    fieldKeys: ['outsourcingSubject'],
    scenarioKey: 'master_record_selection_synced',
    layer: 'web',
    testFile: 'web/src/erp/utils/masterDataOrderView.test.mjs',
  ...
  {
    caseId: 'FL_outsourcing_subject_form__wires_product_and_material_sources',
    title: '委外表单同时接入已登记产品和材料选择真源',
    fieldKeys: ['outsourcingSubject'],
    scenarioKey: 'master_record_selection_synced',
    layer: 'web',
    testFile: 'web/src/erp/utils/masterDataOrderView.test.mjs',
  ...
  {
    caseId: 'FL_processing_contract_material_subject__maps_material_snapshots',
    title: '布料加工合同按材料主体映射材料快照并清除残留产品快照',
    fieldKeys: ['outsourcingSubject', 'accessoryMaterial'],
    scenarioKey: 'source_snapshot_retained',
    layer: 'web',
    testFile: 'web/src/erp/data/processingContractTemplate.test.mjs',
  },
  {
    caseId:
      'FL_processing_contract_subject_type__does_not_guess_missing_subject',
    title: '加工合同主体类型缺失时不根据残留产品或材料字段猜测',
    fieldKeys: ['outsourcingSubject'],
    scenarioKey: 'stale_value_cleared',
    layer: 'web',
    testFile: 'web/src/erp/data/processingContractTemplate.test.mjs',
