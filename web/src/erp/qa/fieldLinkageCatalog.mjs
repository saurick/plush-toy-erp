...
export const FIELD_LINKAGE_CASE_CATALOG = [
  ...
  {
    caseId: 'FL_partner_contacts__syncs_item_contacts_to_payload_summary',
    title: '客户/供应商联系人明细同步到列表摘要字段',
  ...
  {
    caseId: 'FL_partner_contacts__clears_stale_contact_summary',
    title: '清空客户/供应商联系人明细时同步清空旧摘要',
    fieldKeys: ['partnerContacts'],
  ...
  {
    caseId: 'FL_products__mirrors_cn_desc',
    title: '产品中文描述同步到产品快照字段',
    fieldKeys: ['productDescription', 'productNameColor'],
    scenarioKey: 'product_description_mirrored',
    layer: 'web',
    testFile: 'web/src/erp/utils/businessRecordForm.test.mjs',
  },
  {
    caseId: 'FL_master_record_selection__syncs_customer_snapshot',
    title: '选择客户主档时同步软引用和客户快照',
    fieldKeys: ['customerMasterSelection', 'customerName'],
    scenarioKey: 'master_record_selection_synced',
    layer: 'web',
    testFile: 'web/src/erp/utils/businessRecordMasterSelection.test.mjs',
  },
  {
    caseId: 'FL_master_record_selection__syncs_supplier_snapshot',
    title: '选择供应商主档时同步供应商快照',
  ...
  {
    caseId: 'FL_master_record_selection__syncs_product_snapshot',
    title: '选择产品主档时同步产品快照',
    fieldKeys: ['productMasterSelection', 'productNameColor'],
    scenarioKey: 'master_record_selection_synced',
    layer: 'web',
    testFile: 'web/src/erp/utils/businessRecordMasterSelection.test.mjs',
  },
  {
    caseId: 'FL_master_record_selection__keeps_product_record_code_out_of_sku',
    title: '选择产品主档时产品资料编号不兜底写入产品编号 / SKU',
    fieldKeys: ['productMasterSelection', 'productNo'],
    scenarioKey: 'master_record_selection_synced',
    layer: 'web',
    testFile: 'web/src/erp/utils/businessRecordMasterSelection.test.mjs',
  },
  {
    caseId: 'FL_master_record_selection__clears_linked_snapshots',
    title: '清空基础资料选择时同步清空关联快照',
    fieldKeys: ['customerMasterSelection', 'productMasterSelection'],
