...
func (_c *WarehouseCreate) AddProductionFactIDs(ids ...int) *WarehouseCreate {
	_c.mutation.AddProductionFactIDs(ids...)
	return _c
}

// AddProductionFacts adds the "production_facts" edges to the ProductionFact entity.
func (_c *WarehouseCreate) AddProductionFacts(v ...*ProductionFact) *WarehouseCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *WarehouseCreate) AddOutsourcingFactIDs(ids ...int) *WarehouseCreate {
	_c.mutation.AddOutsourcingFactIDs(ids...)
	return _c
}

// AddOutsourcingFacts adds the "outsourcing_facts" edges to the OutsourcingFact entity.
func (_c *WarehouseCreate) AddOutsourcingFacts(v ...*OutsourcingFact) *WarehouseCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *WarehouseCreate) AddShipmentItemIDs(ids ...int) *WarehouseCreate {
	_c.mutation.AddShipmentItemIDs(ids...)
	return _c
}

// AddShipmentItems adds the "shipment_items" edges to the ShipmentItem entity.
func (_c *WarehouseCreate) AddShipmentItems(v ...*ShipmentItem) *WarehouseCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *WarehouseCreate) AddStockReservationIDs(ids ...int) *WarehouseCreate {
...
func (_c *WarehouseCreate) AddStockReservations(v ...*StockReservation) *WarehouseCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
