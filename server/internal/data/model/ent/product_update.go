...
func (_u *ProductUpdate) SetUnitNetWeightG(v decimal.Decimal) *ProductUpdate {
	_u.mutation.SetUnitNetWeightG(v)
	return _u
}

// SetNillableUnitNetWeightG sets the "unit_net_weight_g" field if the given value is not nil.
func (_u *ProductUpdate) SetNillableUnitNetWeightG(v *decimal.Decimal) *ProductUpdate {
	if v != nil {
...
func (_u *ProductUpdate) ClearUnitNetWeightG() *ProductUpdate {
...
func (_u *ProductUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.UnitNetWeightGCleared() {
		_spec.ClearField(product.FieldUnitNetWeightG, field.TypeOther)
	}
...
// SetUnitNetWeightG sets the "unit_net_weight_g" field.
func (_u *ProductUpdateOne) SetUnitNetWeightG(v decimal.Decimal) *ProductUpdateOne {
	_u.mutation.SetUnitNetWeightG(v)
	return _u
}

// SetNillableUnitNetWeightG sets the "unit_net_weight_g" field if the given value is not nil.
func (_u *ProductUpdateOne) SetNillableUnitNetWeightG(v *decimal.Decimal) *ProductUpdateOne {
	if v != nil {
		_u.SetUnitNetWeightG(*v)
	}
	return _u
...
// ClearUnitNetWeightG clears the value of the "unit_net_weight_g" field.
func (_u *ProductUpdateOne) ClearUnitNetWeightG() *ProductUpdateOne {
	_u.mutation.ClearUnitNetWeightG()
	return _u
}
