...
func (_u *ProductUpdate) SetUnitNetWeightKg(v decimal.Decimal) *ProductUpdate {
...
func (_u *ProductUpdate) SetNillableUnitNetWeightKg(v *decimal.Decimal) *ProductUpdate {
	if v != nil {
...
func (_u *ProductUpdate) ClearUnitNetWeightKg() *ProductUpdate {
...
func (_u *ProductUpdate) AddOutsourcingOrderItemIDs(ids ...int) *ProductUpdate {
...
func (_u *ProductUpdate) AddOutsourcingOrderItems(v ...*OutsourcingOrderItem) *ProductUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ProductUpdate) AddShipmentItemIDs(ids ...int) *ProductUpdate {
	_u.mutation.AddShipmentItemIDs(ids...)
	return _u
}

// AddShipmentItems adds the "shipment_items" edges to the ShipmentItem entity.
func (_u *ProductUpdate) AddShipmentItems(v ...*ShipmentItem) *ProductUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ProductUpdate) AddStockReservationIDs(ids ...int) *ProductUpdate {
...
func (_u *ProductUpdate) AddStockReservations(v ...*StockReservation) *ProductUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ProductUpdate) ClearOutsourcingOrderItems() *ProductUpdate {
...
func (_u *ProductUpdate) RemoveOutsourcingOrderItemIDs(ids ...int) *ProductUpdate {
...
func (_u *ProductUpdate) RemoveOutsourcingOrderItems(v ...*OutsourcingOrderItem) *ProductUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ProductUpdate) ClearStockReservations() *ProductUpdate {
...
func (_u *ProductUpdate) RemoveStockReservationIDs(ids ...int) *ProductUpdate {
...
func (_u *ProductUpdate) RemoveStockReservations(v ...*StockReservation) *ProductUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ProductUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.UnitNetWeightKgCleared() {
		_spec.ClearField(product.FieldUnitNetWeightKg, field.TypeOther)
	}
	...
	if _u.mutation.ShipmentItemsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   product.ShipmentItemsTable,
			Columns: []string{product.ShipmentItemsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.StockReservationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   product.StockReservationsTable,
			Columns: []string{product.StockReservationsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetUnitNetWeightKg sets the "unit_net_weight_kg" field.
func (_u *ProductUpdateOne) SetUnitNetWeightKg(v decimal.Decimal) *ProductUpdateOne {
	_u.mutation.SetUnitNetWeightKg(v)
	return _u
}

// SetNillableUnitNetWeightKg sets the "unit_net_weight_kg" field if the given value is not nil.
func (_u *ProductUpdateOne) SetNillableUnitNetWeightKg(v *decimal.Decimal) *ProductUpdateOne {
	if v != nil {
		_u.SetUnitNetWeightKg(*v)
	}
	return _u
...
// ClearUnitNetWeightKg clears the value of the "unit_net_weight_kg" field.
func (_u *ProductUpdateOne) ClearUnitNetWeightKg() *ProductUpdateOne {
	_u.mutation.ClearUnitNetWeightKg()
	return _u
}
...
// AddOutsourcingOrderItemIDs adds the "outsourcing_order_items" edge to the OutsourcingOrderItem entity by IDs.
func (_u *ProductUpdateOne) AddOutsourcingOrderItemIDs(ids ...int) *ProductUpdateOne {
	_u.mutation.AddOutsourcingOrderItemIDs(ids...)
	return _u
}

// AddOutsourcingOrderItems adds the "outsourcing_order_items" edges to the OutsourcingOrderItem entity.
func (_u *ProductUpdateOne) AddOutsourcingOrderItems(v ...*OutsourcingOrderItem) *ProductUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddShipmentItemIDs adds the "shipment_items" edge to the ShipmentItem entity by IDs.
func (_u *ProductUpdateOne) AddShipmentItemIDs(ids ...int) *ProductUpdateOne {
	_u.mutation.AddShipmentItemIDs(ids...)
	return _u
}

// AddShipmentItems adds the "shipment_items" edges to the ShipmentItem entity.
func (_u *ProductUpdateOne) AddShipmentItems(v ...*ShipmentItem) *ProductUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddStockReservationIDs adds the "stock_reservations" edge to the StockReservation entity by IDs.
func (_u *ProductUpdateOne) AddStockReservationIDs(ids ...int) *ProductUpdateOne {
	_u.mutation.AddStockReservationIDs(ids...)
	return _u
}

// AddStockReservations adds the "stock_reservations" edges to the StockReservation entity.
func (_u *ProductUpdateOne) AddStockReservations(v ...*StockReservation) *ProductUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOutsourcingOrderItems clears all "outsourcing_order_items" edges to the OutsourcingOrderItem entity.
func (_u *ProductUpdateOne) ClearOutsourcingOrderItems() *ProductUpdateOne {
	_u.mutation.ClearOutsourcingOrderItems()
	return _u
}

// RemoveOutsourcingOrderItemIDs removes the "outsourcing_order_items" edge to OutsourcingOrderItem entities by IDs.
func (_u *ProductUpdateOne) RemoveOutsourcingOrderItemIDs(ids ...int) *ProductUpdateOne {
	_u.mutation.RemoveOutsourcingOrderItemIDs(ids...)
	return _u
}

// RemoveOutsourcingOrderItems removes "outsourcing_order_items" edges to OutsourcingOrderItem entities.
func (_u *ProductUpdateOne) RemoveOutsourcingOrderItems(v ...*OutsourcingOrderItem) *ProductUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearShipmentItems clears all "shipment_items" edges to the ShipmentItem entity.
func (_u *ProductUpdateOne) ClearShipmentItems() *ProductUpdateOne {
	_u.mutation.ClearShipmentItems()
	return _u
}

// RemoveShipmentItemIDs removes the "shipment_items" edge to ShipmentItem entities by IDs.
func (_u *ProductUpdateOne) RemoveShipmentItemIDs(ids ...int) *ProductUpdateOne {
	_u.mutation.RemoveShipmentItemIDs(ids...)
	return _u
}

// RemoveShipmentItems removes "shipment_items" edges to ShipmentItem entities.
func (_u *ProductUpdateOne) RemoveShipmentItems(v ...*ShipmentItem) *ProductUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearStockReservations clears all "stock_reservations" edges to the StockReservation entity.
func (_u *ProductUpdateOne) ClearStockReservations() *ProductUpdateOne {
	_u.mutation.ClearStockReservations()
	return _u
}

// RemoveStockReservationIDs removes the "stock_reservations" edge to StockReservation entities by IDs.
func (_u *ProductUpdateOne) RemoveStockReservationIDs(ids ...int) *ProductUpdateOne {
	_u.mutation.RemoveStockReservationIDs(ids...)
	return _u
}

// RemoveStockReservations removes "stock_reservations" edges to StockReservation entities.
func (_u *ProductUpdateOne) RemoveStockReservations(v ...*StockReservation) *ProductUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
