...
func (_c *MaterialCreate) AddProductionOrderMaterialRequirementIDs(ids ...int) *MaterialCreate {
...
func (_c *MaterialCreate) AddProductionOrderMaterialRequirements(v ...*ProductionOrderMaterialRequirement) *MaterialCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *MaterialCreate) AddOutsourcingOrderItemIDs(ids ...int) *MaterialCreate {
...
func (_c *MaterialCreate) AddOutsourcingOrderItems(v ...*OutsourcingOrderItem) *MaterialCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
