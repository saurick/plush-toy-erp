...
const (
	// Label holds the string label denoting the productionorderevent type in the database.
	Label = "production_order_event"
	...
	// FieldOrderVersion holds the string denoting the order_version field in the database.
	FieldOrderVersion = "order_version"
	...
	EdgeActor = "actor"
	// Table holds the table name of the productionorderevent in the database.
	Table = "production_order_events"
	// ProductionOrderTable is the table that holds the production_order relation/edge.
	ProductionOrderTable = "production_order_events"
	...
	ActorTable = "production_order_events"
...
// Columns holds all SQL columns for productionorderevent fields.
var Columns = []string{
	FieldID,
...
var (
	...
	// OrderVersionValidator is a validator for the "order_version" field. It is called by the builders before save.
	OrderVersionValidator func(int) error
...
// OrderOption defines the ordering options for the ProductionOrderEvent queries.
...
// ByOrderVersion orders the results by the order_version field.
func ByOrderVersion(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldOrderVersion, opts...).ToFunc()
}
