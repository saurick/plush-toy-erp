...
func (*ProductionFact) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case productionfact.FieldID, productionfact.FieldSubjectID, productionfact.FieldWarehouseID, productionfact.FieldUnitID, productionfact.FieldLotID, productionfact.FieldSourceID, productionfact.FieldSourceLineID:
