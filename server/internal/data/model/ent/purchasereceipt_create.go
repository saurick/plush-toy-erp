...
func (_c *PurchaseReceiptCreate) AddQualityInspectionIDs(ids ...int) *PurchaseReceiptCreate {
...
func (_c *PurchaseReceiptCreate) AddQualityInspections(v ...*QualityInspection) *PurchaseReceiptCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
