...
func DisplayNameIsNil() predicate.AdminUser {
	return predicate.AdminUser(sql.FieldIsNull(FieldDisplayName))
}

// DisplayNameNotNil applies the NotNil predicate on the "display_name" field.
func DisplayNameNotNil() predicate.AdminUser {
	return predicate.AdminUser(sql.FieldNotNull(FieldDisplayName))
}
