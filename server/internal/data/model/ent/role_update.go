...
func (_u *RoleUpdate) SetSortOrder(v int) *RoleUpdate {
...
func (_u *RoleUpdate) SetNillableSortOrder(v *int) *RoleUpdate {
	if v != nil {
		_u.SetSortOrder(*v)
	}
	return _u
...
// SetSortOrder sets the "sort_order" field.
func (_u *RoleUpdateOne) SetSortOrder(v int) *RoleUpdateOne {
	_u.mutation.ResetSortOrder()
	_u.mutation.SetSortOrder(v)
	return _u
}
...
// SetNillableSortOrder sets the "sort_order" field if the given value is not nil.
func (_u *RoleUpdateOne) SetNillableSortOrder(v *int) *RoleUpdateOne {
	if v != nil {
		_u.SetSortOrder(*v)
	}
	return _u
