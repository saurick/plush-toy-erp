...
func PermissionKey(v string) predicate.Permission {
	return predicate.Permission(sql.FieldEQ(FieldPermissionKey, v))
}
...
func Builtin(v bool) predicate.Permission {
	return predicate.Permission(sql.FieldEQ(FieldBuiltin, v))
}
...
func PermissionKeyEQ(v string) predicate.Permission {
	return predicate.Permission(sql.FieldEQ(FieldPermissionKey, v))
}

// PermissionKeyNEQ applies the NEQ predicate on the "permission_key" field.
func PermissionKeyNEQ(v string) predicate.Permission {
	return predicate.Permission(sql.FieldNEQ(FieldPermissionKey, v))
}

// PermissionKeyIn applies the In predicate on the "permission_key" field.
func PermissionKeyIn(vs ...string) predicate.Permission {
	return predicate.Permission(sql.FieldIn(FieldPermissionKey, vs...))
}

// PermissionKeyNotIn applies the NotIn predicate on the "permission_key" field.
func PermissionKeyNotIn(vs ...string) predicate.Permission {
	return predicate.Permission(sql.FieldNotIn(FieldPermissionKey, vs...))
}

// PermissionKeyGT applies the GT predicate on the "permission_key" field.
func PermissionKeyGT(v string) predicate.Permission {
	return predicate.Permission(sql.FieldGT(FieldPermissionKey, v))
}

// PermissionKeyGTE applies the GTE predicate on the "permission_key" field.
func PermissionKeyGTE(v string) predicate.Permission {
	return predicate.Permission(sql.FieldGTE(FieldPermissionKey, v))
}

// PermissionKeyLT applies the LT predicate on the "permission_key" field.
func PermissionKeyLT(v string) predicate.Permission {
	return predicate.Permission(sql.FieldLT(FieldPermissionKey, v))
}

// PermissionKeyLTE applies the LTE predicate on the "permission_key" field.
func PermissionKeyLTE(v string) predicate.Permission {
	return predicate.Permission(sql.FieldLTE(FieldPermissionKey, v))
}

// PermissionKeyContains applies the Contains predicate on the "permission_key" field.
func PermissionKeyContains(v string) predicate.Permission {
	return predicate.Permission(sql.FieldContains(FieldPermissionKey, v))
}

// PermissionKeyHasPrefix applies the HasPrefix predicate on the "permission_key" field.
func PermissionKeyHasPrefix(v string) predicate.Permission {
	return predicate.Permission(sql.FieldHasPrefix(FieldPermissionKey, v))
}

// PermissionKeyHasSuffix applies the HasSuffix predicate on the "permission_key" field.
func PermissionKeyHasSuffix(v string) predicate.Permission {
	return predicate.Permission(sql.FieldHasSuffix(FieldPermissionKey, v))
}

// PermissionKeyEqualFold applies the EqualFold predicate on the "permission_key" field.
func PermissionKeyEqualFold(v string) predicate.Permission {
	return predicate.Permission(sql.FieldEqualFold(FieldPermissionKey, v))
}

// PermissionKeyContainsFold applies the ContainsFold predicate on the "permission_key" field.
func PermissionKeyContainsFold(v string) predicate.Permission {
	return predicate.Permission(sql.FieldContainsFold(FieldPermissionKey, v))
}
...
func BuiltinEQ(v bool) predicate.Permission {
	return predicate.Permission(sql.FieldEQ(FieldBuiltin, v))
}

// BuiltinNEQ applies the NEQ predicate on the "builtin" field.
func BuiltinNEQ(v bool) predicate.Permission {
	return predicate.Permission(sql.FieldNEQ(FieldBuiltin, v))
}
