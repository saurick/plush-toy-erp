...
func (_u *AdminUserUpdate) SetIsSuperAdmin(v bool) *AdminUserUpdate {
	_u.mutation.SetIsSuperAdmin(v)
	return _u
}

// SetNillableIsSuperAdmin sets the "is_super_admin" field if the given value is not nil.
func (_u *AdminUserUpdate) SetNillableIsSuperAdmin(v *bool) *AdminUserUpdate {
	if v != nil {
...
// SetIsSuperAdmin sets the "is_super_admin" field.
func (_u *AdminUserUpdateOne) SetIsSuperAdmin(v bool) *AdminUserUpdateOne {
	_u.mutation.SetIsSuperAdmin(v)
	return _u
}

// SetNillableIsSuperAdmin sets the "is_super_admin" field if the given value is not nil.
func (_u *AdminUserUpdateOne) SetNillableIsSuperAdmin(v *bool) *AdminUserUpdateOne {
	if v != nil {
		_u.SetIsSuperAdmin(*v)
	}
	return _u
