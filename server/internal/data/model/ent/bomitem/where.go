...
func HasProductionOrderMaterialRequirements() predicate.BOMItem {
	return predicate.BOMItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProductionOrderMaterialRequirementsWith(preds ...predicate.ProductionOrderMaterialRequirement) predicate.BOMItem {
	return predicate.BOMItem(func(s *sql.Selector) {
