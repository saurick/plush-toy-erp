...
func (_c *ProductCreate) SetStyleNo(v string) *ProductCreate {
	_c.mutation.SetStyleNo(v)
	return _c
}

// SetNillableStyleNo sets the "style_no" field if the given value is not nil.
func (_c *ProductCreate) SetNillableStyleNo(v *string) *ProductCreate {
	if v != nil {
		_c.SetStyleNo(*v)
	}
	return _c
...
func (_c *ProductCreate) SetCustomerStyleNo(v string) *ProductCreate {
	_c.mutation.SetCustomerStyleNo(v)
	return _c
}

// SetNillableCustomerStyleNo sets the "customer_style_no" field if the given value is not nil.
func (_c *ProductCreate) SetNillableCustomerStyleNo(v *string) *ProductCreate {
	if v != nil {
		_c.SetCustomerStyleNo(*v)
	}
	return _c
}
...
func (_c *ProductCreate) AddBomHeaderIDs(ids ...int) *ProductCreate {
	_c.mutation.AddBomHeaderIDs(ids...)
	return _c
}

// AddBomHeaders adds the "bom_headers" edges to the BOMHeader entity.
func (_c *ProductCreate) AddBomHeaders(v ...*BOMHeader) *ProductCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProductCreate) AddShipmentItemIDs(ids ...int) *ProductCreate {
	_c.mutation.AddShipmentItemIDs(ids...)
	return _c
}

// AddShipmentItems adds the "shipment_items" edges to the ShipmentItem entity.
func (_c *ProductCreate) AddShipmentItems(v ...*ShipmentItem) *ProductCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProductCreate) AddStockReservationIDs(ids ...int) *ProductCreate {
...
func (_c *ProductCreate) AddStockReservations(v ...*StockReservation) *ProductCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProductCreate) check() error {
	...
	if v, ok := _c.mutation.CustomerStyleNo(); ok {
	...
	if len(_c.mutation.DefaultUnitIDs()) == 0 {
		return &ValidationError{Name: "default_unit", err: errors.New(`ent: missing required edge "Product.default_unit"`)}
	}
	return nil
}
