...
func (_q *ProcessQuery) QueryOutsourcingOrderItems() *OutsourcingOrderItemQuery {
...
func (_q *ProcessQuery) WithOutsourcingOrderItems(opts ...func(*OutsourcingOrderItemQuery)) *ProcessQuery {
	query := (&OutsourcingOrderItemClient{config: _q.config}).Query()
...
func (_q *ProcessQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Process, error) {
	...
	if query := _q.withOutsourcingOrderItems; query != nil {
		if err := _q.loadOutsourcingOrderItems(ctx, query, nodes,
			func(n *Process) { n.Edges.OutsourcingOrderItems = []*OutsourcingOrderItem{} },
...
func (_q *ProcessQuery) loadOutsourcingOrderItems(ctx context.Context, query *OutsourcingOrderItemQuery, nodes []*Process, init func(*Process), assign func(*Process, *OutsourcingOrderItem)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(outsourcingorderitem.FieldProcessID)
	}
	query.Where(predicate.OutsourcingOrderItem(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(process.OutsourcingOrderItemsColumn), fks...))
	}))
