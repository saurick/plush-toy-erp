...
func (d *JsonrpcData) handleBusiness(
	...
	if method != "dashboard_stats" && d.businessUC == nil {
...
func (d *JsonrpcData) mapBusinessRecordError(ctx context.Context, err error) *v1.JsonrpcResult {
	...
	case errors.Is(err, biz.ErrBusinessRecordArchiveReadOnly):
		l.Warnf("[business] archive write denied err=%v", err)
		return &v1.JsonrpcResult{Code: errcode.InvalidParam.Code, Message: "business_records 已归档为只读，请使用对应领域入口"}
	default:
