...
func newOperationalFactJSONRPCTestData(admin *biz.AdminUser) *JsonrpcData {
	logger := log.NewStdLogger(io.Discard)
	return &JsonrpcData{
		log:               log.NewHelper(log.With(logger, "module", "data.jsonrpc.operational_fact.test")),
...
func TestJsonrpcData_ShipmentAPIRequiresDedicatedShipmentPermissions(t *testing.T) {
