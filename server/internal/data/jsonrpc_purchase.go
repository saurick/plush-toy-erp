...
func (d *JsonrpcData) handlePurchase(
	ctx context.Context,
	method, id string,
...
func purchaseReceiptResult(ctx context.Context, d *JsonrpcData, item *biz.PurchaseReceipt, err error) *v1.JsonrpcResult {
	if err != nil {
...
func purchaseReceiptItemResult(ctx context.Context, d *JsonrpcData, item *biz.PurchaseReceiptItem, err error) *v1.JsonrpcResult {
	if err != nil {
		return d.mapPurchaseError(ctx, err)
	}
...
func (d *JsonrpcData) mapPurchaseError(ctx context.Context, err error) *v1.JsonrpcResult {
