...
func (d *jsonrpcDispatcher) handleWorkflow(
	...
	case "list_tasks", "list_role_tasks", "get_task_board", "create_task", "complete_task_action", "block_task_action", "reject_task_action", "resume_task_action", "urge_task", "explain_action_access", "explain_task_assignment":
