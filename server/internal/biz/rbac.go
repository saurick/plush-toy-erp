...
var builtinAdminMenus = []AdminMenu{
	...
	{Key: "products", Label: "产品档案", Path: "/erp/master/products", RequiredPermissions: []string{PermissionProductSKURead}},
