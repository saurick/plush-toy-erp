...
var builtinAdminMenus = []AdminMenu{
	...
	{Key: "business-dashboard", Label: "业务总览", Path: "/erp/business-dashboard", RequiredPermissions: []string{PermissionERPDashboardRead}},
