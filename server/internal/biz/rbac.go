...
var builtinAdminMenus = []AdminMenu{
	...
	{Key: "production-scheduling", Label: "排产确认", Path: "/erp/production/scheduling", RequiredAny: []string{PermissionPMCPlanRead}, RequiredAll: []string{PermissionWorkflowTaskRead}},
