...
var builtinAdminMenus = []AdminMenu{
	...
	{Key: "products", Label: "产品", Path: "/erp/master/products", RequiredPermissions: []string{PermissionWarehouseInventoryRead}},
	...
	{Key: "shipping-release", Label: "待出货/出货放行", Path: "/erp/warehouse/shipping-release", RequiredPermissions: []string{PermissionWarehouseOutboundRead}},
