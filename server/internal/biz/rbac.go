...
const (
	...
	PermissionSalesOrderEngineeringUpdate       = "sales_order.engineering.update"
	PermissionEngineeringMaterialRead           = "engineering.material.read"
	PermissionEngineeringMaterialSubmit         = "engineering.material.submit"
	PermissionEngineeringMaterialBossApprove    = "engineering.material.boss_approve"
	PermissionEngineeringMaterialFinanceApprove = "engineering.material.finance_approve"
	...
	PermissionPurchaseOrderSubmit             = "purchase.order.submit"
	PermissionPurchaseOrderClose              = "purchase.order.close"
	PermissionPurchaseOrderCancel             = "purchase.order.cancel"
	...
	PermissionOutsourcingOrderSubmit          = "outsourcing.order.submit"
	PermissionOutsourcingOrderConfirm         = "outsourcing.order.confirm"
	PermissionOutsourcingOrderClose           = "outsourcing.order.close"
	PermissionOutsourcingOrderCancel          = "outsourcing.order.cancel"
	...
	PermissionPurchaseReceiptCancelDraft      = "purchase.receipt.cancel_draft"
	...
	PermissionWarehouseManage                 = "warehouse.manage"
	...
	PermissionWarehouseAdjustmentApprove      = "warehouse.adjustment.approve"
	...
	PermissionShipmentUpdate                  = "shipment.update"
	...
	PermissionProductionExceptionSubmit       = "production.exception.submit"
	PermissionProductionExceptionApprove      = "production.exception.approve"
	...
	PermissionFinancePaymentApprove           = "finance.payment.approve"
...
var builtinPermissionModuleNames = map[string]string{
	"system":          "系统管理",
...
var builtinPermissions = withBuiltinPermissionMetadata([]PermissionDefinition{
	...
	{Key: PermissionSalesOrderEngineeringUpdate, Name: "维护订单工程与打样", Module: "sales_order", Action: "update", Resource: "engineering", Builtin: true},
	{Key: PermissionEngineeringMaterialRead, Name: "查看工程用料汇总", Module: "engineering", Action: "read", Resource: "material", Builtin: true},
	{Key: PermissionEngineeringMaterialSubmit, Name: "提交工程用料审批", Module: "engineering", Action: "submit", Resource: "material", Builtin: true},
	{Key: PermissionEngineeringMaterialBossApprove, Name: "审核工程用料", Module: "engineering", Action: "boss_approve", Resource: "material", Builtin: true},
	{Key: PermissionEngineeringMaterialFinanceApprove, Name: "审核批准工程采购", Module: "engineering", Action: "finance_approve", Resource: "material", Builtin: true},
	...
	{Key: PermissionPurchaseOrderSubmit, Name: "提交采购审批", Module: "purchase", Action: "submit", Resource: "order", Builtin: true},
	{Key: PermissionPurchaseOrderClose, Name: "关闭采购订单", Module: "purchase", Action: "close", Resource: "order", Builtin: true},
	{Key: PermissionPurchaseOrderCancel, Name: "取消采购订单", Module: "purchase", Action: "cancel", Resource: "order", Builtin: true},
	...
	{Key: PermissionOutsourcingOrderSubmit, Name: "提交委外合同", Module: "outsourcing", Action: "submit", Resource: "order", Builtin: true},
	{Key: PermissionOutsourcingOrderConfirm, Name: "确认委外下单", Module: "outsourcing", Action: "confirm", Resource: "order", Builtin: true},
	{Key: PermissionOutsourcingOrderClose, Name: "关闭委外合同", Module: "outsourcing", Action: "close", Resource: "order", Builtin: true},
	{Key: PermissionOutsourcingOrderCancel, Name: "取消委外合同", Module: "outsourcing", Action: "cancel", Resource: "order", Builtin: true},
	...
	{Key: PermissionPurchaseReceiptCancelDraft, Name: "取消未入库到货登记", Module: "purchase", Action: "cancel_draft", Resource: "receipt", Builtin: true},
	...
	{Key: PermissionWarehouseManage, Name: "维护仓库", Module: "warehouse", Action: "manage", Resource: "warehouse", Builtin: true},
	...
	{Key: PermissionWarehouseInboundConfirm, Name: "确认采购或成品入库", Module: "warehouse", Action: "confirm", Resource: "inbound", Builtin: true},
	...
	{Key: PermissionWarehouseAdjustmentApprove, Name: "审批库存调整", Module: "warehouse", Action: "approve", Resource: "adjustment", Builtin: true},
	...
	{Key: PermissionShipmentUpdate, Name: "编辑出货草稿", Module: "shipment", Action: "update", Resource: "shipment", Builtin: true},
	...
	{Key: PermissionProductionExceptionSubmit, Name: "提交生产异常处置申请", Module: "production", Action: "submit", Resource: "exception", Builtin: true},
	{Key: PermissionProductionExceptionApprove, Name: "审批生产异常处置", Module: "production", Action: "approve", Resource: "exception", Builtin: true},
	...
	{Key: PermissionFinancePaymentApprove, Name: "审批收付款", Module: "finance", Action: "approve", Resource: "payment", Builtin: true},
	...
	{Key: PermissionProductionFactPost, Name: "确认生产领料或返工", Module: "production", Action: "post", Resource: "fact", Builtin: true},
	{Key: PermissionProductionFactCancel, Name: "取消生产领料、返工或待入库完工报告", Module: "production", Action: "cancel", Resource: "fact", Builtin: true},
...
func withBuiltinPermissionMetadata(items []PermissionDefinition) []PermissionDefinition {
	for index := range items {
		...
		case item.Module == "system" || item.Module == "customer_config" || item.Module == "process_runtime":
...
func PermissionModuleName(moduleKey string) (string, bool) {
	name, ok := builtinPermissionModuleNames[strings.TrimSpace(moduleKey)]
	return name, ok
}
...
func BuiltinRoles() []RoleDefinition {
	...
	roles := []RoleDefinition{
		{Key: BossRoleKey, Name: "老板 / 管理层", Description: "查看全局业务、审批和报表，不默认包含高危 debug 清空权限。", Builtin: true, SortOrder: 10, Permissions: append(readPermissions, PermissionEngineeringMaterialRead, PermissionEngineeringMaterialBossApprove, PermissionFieldPartyPrivateRead, PermissionFieldSalesCommercialRead, PermissionFieldProcurementCommercialRead, PermissionFieldFinanceSettlementRead, PermissionProductionFactRead, PermissionProductionExceptionApprove, PermissionWarehouseAdjustmentApprove, PermissionFinancePaymentApprove, PermissionWorkflowTaskSupervise, PermissionWorkflowTaskAssign, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskApprove, PermissionWorkflowTaskReject, PermissionMobileBossAccess)},
		{Key: SalesRoleKey, Name: "业务", Description: "客户、订单、出运跟进，任务处理仍受销售 责任岗位和当前处理人 约束。", Builtin: true, SortOrder: 20, Permissions: []string{PermissionEngineeringMaterialRead, PermissionERPWorkbenchRead, PermissionERPPrintTemplateRead, PermissionFieldPartyPrivateRead, PermissionFieldSalesCommercialRead, PermissionCustomerRead, PermissionCustomerCreate, PermissionCustomerUpdate, PermissionCustomerDisable, PermissionMaterialRead, PermissionProcessRead, PermissionProductRead, PermissionProductCreate, PermissionProductUpdate, PermissionProductDisable, PermissionProductSKURead, PermissionProductSKUCreate, PermissionProductSKUUpdate, PermissionProductSKUDisable, PermissionBOMRead, PermissionContactRead, PermissionContactCreate, PermissionContactUpdate, PermissionContactDisable, PermissionContactSetPrimary, PermissionSalesOrderRead, PermissionSalesOrderCreate, PermissionSalesOrderUpdate, PermissionSalesOrderSubmit, PermissionSalesOrderActivate, PermissionSalesOrderClose, PermissionSalesOrderCancel, PermissionSalesOrderItemRead, PermissionWarehouseInventoryRead, PermissionStockReservationCreate, PermissionStockReservationRelease, PermissionShipmentRead, PermissionShipmentCreate, PermissionShipmentUpdate, PermissionProductionWIPRead, PermissionPackagingMaterialConfirm, PermissionWorkflowTaskRead, PermissionWorkflowTaskCreate, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskComplete, PermissionWorkflowTaskReject, PermissionMobileSalesAccess}},
		{Key: PurchaseRoleKey, Name: "采购", Description: "采购、收货、退货相关入口，任务处理仍受采购 责任岗位和当前处理人 约束。", Builtin: true, SortOrder: 30, Permissions: []string{PermissionEngineeringMaterialRead, PermissionERPWorkbenchRead, PermissionERPPrintTemplateRead, PermissionFieldPartyPrivateRead, PermissionFieldProcurementCommercialRead, PermissionSupplierRead, PermissionSupplierCreate, PermissionSupplierUpdate, PermissionSupplierDisable, PermissionMaterialRead, PermissionProcessRead, PermissionProductRead, PermissionMaterialCreate, PermissionMaterialUpdate, PermissionMaterialDisable, PermissionProductSKURead, PermissionBOMRead, PermissionContactRead, PermissionContactCreate, PermissionContactUpdate, PermissionContactDisable, PermissionContactSetPrimary, PermissionWorkflowTaskRead, PermissionWorkflowTaskCreate, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskComplete, PermissionWorkflowTaskReject, PermissionPurchaseOrderRead, PermissionPurchaseOrderCreate, PermissionPurchaseOrderUpdate, PermissionPurchaseOrderSubmit, PermissionPurchaseOrderClose, PermissionPurchaseOrderCancel, PermissionOutsourcingOrderRead, PermissionOutsourcingOrderCreate, PermissionOutsourcingOrderUpdate, PermissionOutsourcingOrderSubmit, PermissionOutsourcingOrderConfirm, PermissionOutsourcingOrderClose, PermissionOutsourcingOrderCancel, PermissionOutsourcingFactRead, PermissionPurchaseReceiptRead, PermissionPurchaseReceiptAdjustmentRead, PermissionPurchaseReceiptAdjustmentCreate, PermissionPurchaseReceiptAdjustmentPost, PermissionPurchaseReceiptAdjustmentCancel, PermissionPurchaseReturnRead, PermissionPurchaseReturnCreate, PermissionPurchaseReturnPost, PermissionPurchaseReturnCancel, PermissionQualityInspectionRead, PermissionWarehouseInventoryRead, PermissionMobilePurchaseAccess}},
		{Key: WarehouseRoleKey, Name: "仓库", Description: "库存、采购与成品入库、出库、盘点相关入口，任务处理仍受仓库 责任岗位和当前处理人 约束。", Builtin: true, SortOrder: 40, Permissions: []string{PermissionContactRead, PermissionOutsourcingOrderRead, PermissionPurchaseReceiptCreate, PermissionPurchaseOrderRead, PermissionWarehouseManage, PermissionERPWorkbenchRead, PermissionCustomerRead, PermissionSupplierRead, PermissionMaterialRead, PermissionProcessRead, PermissionProductRead, PermissionProductSKURead, PermissionSalesOrderRead, PermissionSalesOrderItemRead, PermissionWorkflowTaskRead, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskComplete, PermissionWorkflowTaskReject, PermissionPurchaseReceiptRead, PermissionPurchaseReceiptAdjustmentRead, PermissionPurchaseReceiptAdjustmentCreate, PermissionPurchaseReceiptAdjustmentPost, PermissionPurchaseReceiptAdjustmentCancel, PermissionPurchaseReturnRead, PermissionPurchaseReturnCreate, PermissionPurchaseReturnPost, PermissionPurchaseReturnCancel, PermissionOutsourcingFactRead, PermissionOutsourcingMaterialIssueCreate, PermissionOutsourcingReturnReceiptCreate, PermissionOutsourcingFactPost, PermissionOutsourcingFactCancel, PermissionProductionFactRead, PermissionProductionWIPRead, PermissionQualityInspectionRead, PermissionWarehouseInventoryRead, PermissionWarehouseInboundRead, PermissionWarehouseInboundConfirm, PermissionWarehouseOutboundRead, PermissionWarehouseOutboundConfirm, PermissionWarehouseAdjustmentCreate, PermissionStockReservationCreate, PermissionStockReservationRelease, PermissionShipmentRead, PermissionShipmentCreate, PermissionShipmentUpdate, PermissionShipmentShip, PermissionShipmentCancel, PermissionMobileWarehouseAccess}},
		{Key: QualityRoleKey, Name: "品质", Description: "检验、异常、返工相关入口，任务处理仍受品质 责任岗位和当前处理人 约束。", Builtin: true, SortOrder: 50, Permissions: []string{PermissionERPWorkbenchRead, PermissionCustomerRead, PermissionSupplierRead, PermissionContactRead, PermissionMaterialRead, PermissionProcessRead, PermissionProductRead, PermissionProductSKURead, PermissionSalesOrderRead, PermissionSalesOrderItemRead, PermissionOutsourcingOrderRead, PermissionOutsourcingFactRead, PermissionWorkflowTaskRead, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskComplete, PermissionWorkflowTaskReject, PermissionPurchaseOrderRead, PermissionPurchaseReceiptCreate, PermissionPurchaseReceiptCancelDraft, PermissionPurchaseReceiptRead, PermissionPurchaseReturnRead, PermissionPurchaseReturnCreate, PermissionWarehouseInventoryRead, PermissionShipmentRead, PermissionProductionWIPRead, PermissionQualityInspectionRead, PermissionQualityInspectionCreate, PermissionQualityInspectionUpdate, PermissionQualityExceptionHandle, PermissionProductionExceptionSubmit, PermissionMobileQualityAccess}},
		{Key: FinanceRoleKey, Name: "财务", Description: "应收、应付、发票、对账、收付款和财务报表相关入口，任务处理仍受财务 责任岗位和当前处理人 约束。", Builtin: true, SortOrder: 60, Permissions: []string{PermissionEngineeringMaterialRead, PermissionEngineeringMaterialFinanceApprove, PermissionERPWorkbenchRead, PermissionERPPrintTemplateRead, PermissionFieldPartyPrivateRead, PermissionFieldSalesCommercialRead, PermissionFieldProcurementCommercialRead, PermissionFieldFinanceSettlementRead, PermissionCustomerRead, PermissionSupplierRead, PermissionContactRead, PermissionMaterialRead, PermissionProcessRead, PermissionProductRead, PermissionProductSKURead, PermissionPurchaseOrderRead, PermissionOutsourcingOrderRead, PermissionOutsourcingFactRead, PermissionPurchaseReceiptRead, PermissionPurchaseReceiptAdjustmentRead, PermissionPurchaseReturnRead, PermissionQualityInspectionRead, PermissionSalesOrderRead, PermissionSalesOrderItemRead, PermissionWarehouseInventoryRead, PermissionShipmentRead, PermissionWorkflowTaskRead, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskComplete, PermissionWorkflowTaskReject, PermissionFinancePayableRead, PermissionFinancePayableConfirm, PermissionFinanceInvoiceRead, PermissionFinanceInvoiceConfirm, PermissionFinanceReceivableRead, PermissionFinanceReceivableConfirm, PermissionFinanceReconciliationRead, PermissionFinanceReconciliationConfirm, PermissionFinanceReportRead, PermissionFinancePaymentRead, PermissionFinancePaymentCreate, PermissionFinancePaymentPost, PermissionFinancePaymentReverse, PermissionFinanceCreditNoteCreate, PermissionFinanceCreditNoteReverse, PermissionMobileFinanceAccess}},
		{Key: PMCRoleKey, Name: "PMC", Description: "生产计划、进度和风险跟进；可查看风险，不等于可代替其他角色完成任务。", Builtin: true, SortOrder: 70, Permissions: []string{PermissionEngineeringMaterialRead, PermissionERPWorkbenchRead, PermissionCustomerRead, PermissionContactRead, PermissionSalesOrderRead, PermissionSalesOrderItemRead, PermissionMaterialRead, PermissionProcessRead, PermissionProcessCreate, PermissionProcessUpdate, PermissionProcessDisable, PermissionProductRead, PermissionMaterialCreate, PermissionMaterialUpdate, PermissionProductCreate, PermissionProductUpdate, PermissionProductDisable, PermissionProductSKURead, PermissionProductSKUCreate, PermissionProductSKUUpdate, PermissionProductSKUDisable, PermissionBOMRead, PermissionBOMCreate, PermissionBOMUpdate, PermissionBOMActivate, PermissionShipmentRead, PermissionWorkflowTaskRead, PermissionWorkflowTaskSupervise, PermissionWorkflowTaskCreate, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskComplete, PermissionWorkflowTaskReject, PermissionProductionFactRead, PermissionProductionWIPRead, PermissionPMCPlanRead, PermissionPMCPlanCreate, PermissionPMCPlanUpdate, PermissionPMCRiskRead, PermissionPMCRiskHandle, PermissionMobilePMCAccess}},
		{Key: ProductionRoleKey, Name: "生产", Description: "排产、委外加工、进度、返工和生产异常处置，任务处理仍受生产 责任岗位和当前处理人 约束。", Builtin: true, SortOrder: 80, Permissions: []string{PermissionERPWorkbenchRead, PermissionERPPrintTemplateRead, PermissionFieldPartyPrivateRead, PermissionFieldProcurementCommercialRead, PermissionSupplierRead, PermissionMaterialRead, PermissionProcessRead, PermissionProductRead, PermissionProductSKURead, PermissionContactRead, PermissionOutsourcingOrderRead, PermissionOutsourcingFactRead, PermissionQualityInspectionRead, PermissionWarehouseInventoryRead, PermissionWorkflowTaskRead, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskComplete, PermissionWorkflowTaskReject, PermissionProductionFactRead, PermissionProductionWIPRead, PermissionProductionWIPAssign, PermissionProductionWIPExecute, PermissionProductionWIPRework, PermissionProductionCompletionCreate, PermissionProductionMaterialIssueCreate, PermissionProductionReworkCreate, PermissionProductionFactPost, PermissionProductionFactCancel, PermissionProductionExceptionSubmit, PermissionPMCPlanRead, PermissionPMCPlanUpdate, PermissionPMCRiskRead, PermissionPMCRiskHandle, PermissionMobileProductionAccess}},
		{Key: EngineeringRoleKey, Name: "工程", Description: "产品资料、材料、工艺、BOM 和工程资料任务入口，任务处理仍受工程 责任岗位和当前处理人 约束。", Builtin: true, SortOrder: 90, Permissions: []string{PermissionEngineeringMaterialRead, PermissionEngineeringMaterialSubmit, PermissionSalesOrderEngineeringUpdate, PermissionERPWorkbenchRead, PermissionERPPrintTemplateRead, PermissionCustomerRead, PermissionContactRead, PermissionSalesOrderRead, PermissionSalesOrderItemRead, PermissionSupplierRead, PermissionMaterialRead, PermissionMaterialCreate, PermissionMaterialUpdate, PermissionMaterialDisable, PermissionProcessRead, PermissionProcessCreate, PermissionProcessUpdate, PermissionProcessDisable, PermissionProductRead, PermissionProductCreate, PermissionProductUpdate, PermissionProductSKURead, PermissionProductSKUCreate, PermissionProductSKUUpdate, PermissionBOMRead, PermissionBOMCreate, PermissionBOMUpdate, PermissionBOMActivate, PermissionWorkflowTaskRead, PermissionWorkflowTaskUpdate, PermissionWorkflowTaskComplete, PermissionWorkflowTaskReject, PermissionMobileEngineeringAccess}},
...
var builtinAdminMenus = []AdminMenu{
	...
	{Key: "production-scheduling", Label: "生产排程", Path: "/erp/production/scheduling", RequiredAny: []string{PermissionPMCPlanRead}, RequiredAll: []string{PermissionWorkflowTaskRead}},
	{Key: "production-progress", Label: "生产进度", Path: "/erp/production/progress", RequiredAny: []string{PermissionProductionFactRead}},
	{Key: "production-exceptions", Label: "生产异常处置", Path: "/erp/production/exceptions", RequiredAny: []string{PermissionWorkflowTaskRead, PermissionPMCRiskRead, PermissionProductionFactRead, PermissionProductionExceptionSubmit, PermissionProductionExceptionApprove}},
	...
	{Key: "finance-payments", Label: "收付款核销", Path: "/erp/finance/payments", RequiredAny: []string{PermissionFinancePaymentRead}},
