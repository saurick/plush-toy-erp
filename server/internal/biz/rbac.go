...
const (
	...
	PermissionSalesReturnReverse              = "sales_return.reverse"
...
var builtinPermissions = withBuiltinPermissionMetadata([]PermissionDefinition{
	...
	{Key: PermissionSalesReturnReverse, Name: "冲正客户退货入库", Module: "sales_return", Action: "reverse", Resource: "return", Builtin: true},
