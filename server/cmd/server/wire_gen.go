...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger, tracerProvider *trace.TracerProvider) (*kratos.App, func(), error) {
	...
	jsonrpcData := data.NewJsonrpcData(dataData, confData, logger, authRepo, adminAuthRepo, tokenGenerator, adminTokenGenerator, adminManageRepo, userAdminRepo, tracerProvider)
