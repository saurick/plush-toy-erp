...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger, tracerProvider *trace.TracerProvider) (*kratos.App, func(), error) {
	...
	jsonrpcService := service.NewJsonrpcService(confData, logger, authUsecase, adminAuthUsecase, adminManageUsecase, userAdminUsecase, workflowUsecase, debugUsecase, masterDataUsecase, salesOrderUsecase, purchaseOrderUsecase, inventoryUsecase, operationalFactUsecase, adminAuthRepo)
