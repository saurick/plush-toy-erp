...
function printHelp() {
  process.stdout.write([
    ...
    "",
    "说明:",
    "  两个 target 都验证固定 admin；只有 demo-133 读取并认证合同精确列出的 11 个 UAT 账号，",
