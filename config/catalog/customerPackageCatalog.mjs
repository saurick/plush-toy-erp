export const customerPackageCatalog = Object.freeze({
  ...
  modules: Object.freeze([
    ...
    { key: "sales_returns", label: "销售退货", layer: "SourceDocument" },
    { key: "purchase_orders", label: "采购订单", layer: "SourceDocument" },
    { key: "purchase_receipts", label: "采购入库", layer: "Fact" },
    { key: "quality_inspections", label: "质量检验", layer: "Fact" },
    ...
    { key: "finance_payments", label: "收付款与核销", layer: "Fact" },
  ...
  pages: Object.freeze([
    { key: "global-dashboard", label: "岗位工作台", requiredCapabilityKeys: ["erp.workbench.read", "workflow.task.read"] },
    { key: "task-board", label: "任务看板", requiredCapabilityKeys: ["workflow.task.read"] },
    { key: "business-dashboard", label: "业务看板", requiredCapabilityKeys: ["erp.business_dashboard.read", "workflow.task.read"] },
    ...
    { key: "sales-returns", label: "销售退货", requiredCapabilityKeys: ["sales_return.read", "shipment.read"] },
    ...
    { key: "quality-inspections", label: "质量检验", requiredCapabilityKeys: ["quality.inspection.read", "purchase.receipt.read", "warehouse.inventory.read", "material.read", "product.read"] },
    ...
    { key: "production-scheduling", label: "生产排程", requiredCapabilityKeys: ["pmc.plan.read", "workflow.task.read"] },
    ...
    { key: "finance-payments", label: "收付款与核销", requiredCapabilityKeys: ["finance.payment.read", "finance.receivable.read", "finance.payable.read", "customer.read", "supplier.read"] },
