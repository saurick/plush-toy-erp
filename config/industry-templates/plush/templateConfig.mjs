export const plushIndustryTemplateConfig = Object.freeze({
  ...
  mobileTaskPatternTemplate: Object.freeze([
    ...
    {
      key: "shipment_finance_approval",
      label: "出货财务审批（流程生成）",
      roles: Object.freeze(["finance"]),
      classification: "industry_default_candidate",
      factBoundary: "workflow_to_domain_gate",
      sourceGenerated: true,
      configurableProducer: false,
      producer: "process_runtime.finished_goods_delivery",
      sourcePageKey: "shipments",
      sourceAction: "start_finished_goods_delivery_process",
      ownerRoleKey: "finance",
      precondition: "出货单启动成品交付流程，成品质检领域关口通过后，才生成财务审批。",
      downstream: "审批通过只写 Shipment 版本化财务放行门禁；仓库随后执行真实出货，达到 SHIPPED 后再进入应收线索。",
      note: "财务审批任务完成不等于 SHIPPED、库存 OUT、应收过账、开票或收付款。",
    },
    {
