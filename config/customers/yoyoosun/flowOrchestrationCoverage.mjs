export const yoyoosunFlowOrchestrationCoverage = Object.freeze({
  ...
  layers: Object.freeze([
    ...
    Object.freeze({ key: 'process_runtime', status: 'runtime_enabled_local_target_evidence_required', evidence: Object.freeze(['sales_order_acceptance', 'material_supply', 'finished_goods_delivery']) }),
