export const yoyoosunTrialDataFixture = Object.freeze({
  ...
  bomVersions: Object.freeze([
    Object.freeze({
      ...
      sourceOrderNo: "WL260102",
      quantityText: "3030",
      spareText: "含损耗备品",
      printDate: "2026-01-19",
      designer: "罗伟",
      maker: "成慧怡",
      auditor: "工程审核",
      hairDirection: "单方向",
