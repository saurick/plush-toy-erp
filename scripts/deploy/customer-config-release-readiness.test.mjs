...
function buildReleaseReport({ root, manifest, evidenceDir, overrides = {} }) {
  ...
  const defaultEffectiveSessionVerification =
    activate || rollback
      ? {
          ...
          customerKey: "yoyoosun",
          revision: "yoyoosun-customer-package-v6.runtime-manifest-v1",
          configRevision: "yoyoosun-customer-package-v6.runtime-manifest-v1",
  ...
  return {
    ...
    revision:
      overrides.revision ?? "yoyoosun-customer-package-v6.runtime-manifest-v1",
    executed,
    activate,
...
test("readback preflight report accepts existing release and target smoke evidence", async () => {
  ...
  try {
    ...
    assert.equal(report.manifest.revision, "yoyoosun-customer-package-v6.runtime-manifest-v1");
