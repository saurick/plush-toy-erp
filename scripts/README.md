...
| `scripts/qa/prepare-push.sh`                                                                                                                                                                                       | 最终 clean HEAD 推送准备；普通模式按真实 remote/ref 复算 affected，必要时显式 `--full`；`--review` 则只为固定远端 `review/gpt` 执行提交格式与严格 secrets，签发不能用于 main/发布的独立审查回执                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | commit 后、立即 push 前；或网页 GPT 审查快照前                                                              |
