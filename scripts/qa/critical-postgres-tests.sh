...
CRITICAL_POSTGRES_TEST_PATTERN='^(TestBusinessDocumentSearchPostgres|TestAdminManagePostgres|TestDatabaseGovernancePostgres|TestDatabaseGovernanceWorkflowTaskEventHookRejectsMutation|TestPurchaseReceiptPostgres|TestPurchaseReceiptAdjustmentPostgres|TestPurchaseReturnPostgres|TestPurchaseReturnFromQualityInspectionPostgres|TestQualityInspectionPostgres|TestQualityInspectionFromOutsourcingReturnPostgres|TestProductionWIPQualityInspectionPostgres|TestSourceFinanceSnapshotBackfillMigrationPostgres|TestWorkflowPostgres|TestCustomerConfigPostgres|TestMasterDataSchemaPostgres|TestProductionOrderSchemaPostgres|TestProductionOrderPostgres|TestProductionMaterialIssuePostgres|TestProductionReworkPostgres|TestSourceDocumentPostgres|TestSourceOrderLifecyclePostgres|TestInventoryPostgres|TestInventoryLotPostgres|TestInventoryLotStatusPostgres|TestBOMPostgres|TestOperationalFactPostgres|TestOutsourcingFactFromOrderPostgres|TestOutsourcingNormalClosePostgres|TestProcessRuntimePostgres|TestFinanceBusinessSourcesPostgres|TestOperationalFactRepoFinance.*Postgres|TestFinanceFactCancelAuditPostgres|TestFinanceProcessCommandPostgres|TestSalesProcessCommandPostgres)'

CRITICAL_POSTGRES_REQUIRED_PREFIXES=(
  TestBusinessDocumentSearchPostgres
  TestAdminManagePostgres
  TestDatabaseGovernancePostgres
