...
| 本地开发库迁移       | `dev-database-migration-operation-store.mjs`、`../../web/devDatabaseMigrationPlugin.mjs`、`../../web/devDatabaseMigrationRuntime.mjs`                                                                                                                                                                                                                                                                                                                                                                                                                                             | 只包装登记共享开发库的 status / plan / backup-restore / apply / readback / restart；固定意图、幂等、单执行锁、无自动重试，不接受任意目标、命令、SQL 或凭据                                                     |
