...
| `node --test scripts/qa/schema-docs.test.mjs`                                                                                       | 校验 Ent generated migration descriptor、72 表业务语义 catalog 与 8 份生成数据字典零漂移；不连接数据库                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 调整 schema、catalog、生成器或数据库文档后       |
