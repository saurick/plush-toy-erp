...
const FAST_REQUIRED_FILES = Object.freeze([
  ...
  "scripts/qa/dev-coverage-operation-store.mjs",
  "scripts/qa/dev-coverage-operation-store.test.mjs",
  "scripts/qa/dev-qa-execution-lock.mjs",
  "scripts/qa/dev-qa-execution-lock.test.mjs",
  "scripts/qa/dev-testing-operation-store.mjs",
  ...
  "server/cmd/schema-doc/main.go",
  "server/cmd/schema-doc/main_test.go",
  "server/docs/database/table-catalog.json",
  "server/docs/database/README.md",
  "server/docs/database/账号权限与配置.md",
  "server/docs/database/主数据与BOM.md",
  "server/docs/database/销售与采购.md",
  "server/docs/database/库存与质检.md",
  "server/docs/database/生产与委外.md",
  "server/docs/database/出货与财务.md",
  "server/docs/database/流程运行时.md",
  ...
  "web/src/dev-workbench/config/devCoverageOperation.mjs",
  "web/src/dev-workbench/config/devCoverageOperation.test.mjs",
  "web/src/dev-workbench/config/devTestingOperation.mjs",
  "web/src/dev-workbench/config/devTestingOperation.test.mjs",
  ...
  "web/dev-server/devWorkbenchReceiptPlugin.test.mjs",
  ...
  "web/dev-server/devQaTestingPlugin.test.mjs",
