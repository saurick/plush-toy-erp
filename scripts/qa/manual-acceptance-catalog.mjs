...
const ENTRY_PLANS = Object.freeze({
  "admin-login": {
    ...
    whatToSee: [
      "应看到正常账号进入入口选择页，错误密码、停用账号和未填完整信息都有清楚的中文提示。",
...
const DESKTOP_PLANS = Object.freeze({
  ...
  reconciliation: {
    ...
    whatToDo: [
      ...
      "你要比较金额、手续费、币种和账期，再打开草稿、已过账、已结清和已取消记录。",
    ],
    whatToSee: [
      "应看到往来单位、金额、手续费、币种、账期和状态清楚，金额合计可以核对。",
  ...
  payables: {
    ...
    whatToDo: [
      "你要按供应商、来源单号、状态和日期查找，打开不同账期和发票类别的记录。",
      "你要核对金额、手续费、币种、账期和来源，再比较草稿、已过账、已结清和已取消记录。",
    ],
    whatToSee: [
      "应看到供应商、来源、金额、手续费、币种、账期和状态清楚，无来源时不补造单号。",
  ...
  receivables: {
    ...
    whatToDo: [
      "你要按客户、出货单号、状态和日期查找，打开不同收款分类和账期的记录。",
      "你要从已经出货的来源核对金额、手续费、币种和账期，再比较四种进度。",
    ],
    whatToSee: [
      "应看到客户、出货来源、金额、手续费、币种、账期和状态清楚，未出货记录不会被当成应收来源。",
  ...
  invoices: {
    ...
    keyStates: ["草稿", "已过账", "已结清", "已取消", "不开票", "多种发票类别"],
    whatToDo: [
      "你要按往来单位、记录号、状态和日期查找，打开不开票与不同发票类别的记录。",
      "你要核对金额、手续费、币种、发票类别和出货来源，再比较四种进度。",
    ],
    whatToSee: [
