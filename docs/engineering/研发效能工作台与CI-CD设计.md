...
| Profile           | 目标与内容                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 退出 / 清理                                                                                                                                                                                                                             |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `core-demo`       | 仅允许登记的 `192.168.0.106:5432/plush_erp` 或 `plush_erp_*_dev`，先确认 migration 已到 head，再顺序准备十个演示账号、当前 V6 的 11 个单位与 4 个仓库；不生成材料、产品、工艺、BOM、客户、订单、Workflow 或 Fact，后续版本化数据统一由 `scenario-demo` 接续准备                                                                                                                                                                                                                                                                                                   | 作为本地长期基础引用保留；不提供按 operation 删除按钮，账号和主数据按正式生命周期退出                                                                                                                                                   |
