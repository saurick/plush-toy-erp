...
本目录保存已经退出活跃 `docs/architecture/` 入口的旧实现评审文档。
...
| 文件 | 原活跃用途 | 当前处理 |
| --- | --- | --- |
| `bom-lot-schema-review.md` | BOM 与库存批次实现评审 | 历史实现评审归档 |
| `purchase-receipt-review.md` | 采购入库最小闭环实现评审 | 历史实现评审归档 |
| `purchase-return-quality-review.md` | 采购退货 / 入库差异 / 来料质检入口实现评审 | 历史实现评审归档 |
