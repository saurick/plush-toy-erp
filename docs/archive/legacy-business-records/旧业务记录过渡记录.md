...
本文保留旧 `business_records` 过渡阶段的背景和边界。当前运行时已经越过“只读兼容层”阶段：`business_records / business_record_items / business_record_events` 已由 `20260612112337` migration 删除。当前状态以 `docs/当前真源与交接顺序.md` 为准，删除过程仅在本归档目录追溯。
