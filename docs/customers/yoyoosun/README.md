...
| 核对甲方确认的生产流程 | `需求线索.md` 的“客户已确认的生产与外发主线” | `流程编排闭环矩阵.md`、`config/customers/yoyoosun/customerPackage.mjs`、当前代码和测试 |
...
| 分组 | 文档 |
| --- | --- |
| 甲方面谈、角色与协作流程 | `甲方角色职责与业务流转确认表.md`、`角色能力与流程矩阵.md`、`流程编排闭环矩阵.md`、`需求线索.md` |
