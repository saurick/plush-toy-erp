...
- 原始 Excel / PDF / PNG / JPG / JPEG 本轮纳入项目，归档到 `docs/customers/yoyoosun/raw-source-files/`，保留原始文件名，方便后续功能、字段和模板溯源。
...
| `raw-source-files/Weixin Image_20260420164444_2155_288.png` | PNG | 80528 | Customer Material / QA Debug / Field Clue | 归档原件；作为截图线索；不能作为唯一字段、流程或事实真源 |
| `raw-source-files/Weixin Image_20260413193511_710_288.png` | PNG | 522183 | Customer Material / Workflow Clue / Field Clue | 归档原件；作为永绅岗位职责流程、岗位节点和 Workflow / Fact 边界线索；不自动升级为 Product Core 流程真源 |
| `raw-source-files/Weixin Image_20260421153105_2272_288.jpeg` | JPEG | 392476 | Customer Material / Print Template Input / Field Clue | 归档原件；作为合同订单字段、条款和纸面样式线索；与同名 `.jpg` 是同一张照片的另一份源文件，不重复计为独立业务单据 |
| `raw-source-files/Weixin Image_20260421153105_2272_288.jpg` | JPEG | 473184 | Customer Material / Print Template Input / Field Clue | 归档原件；作为合同订单字段、条款和纸面样式线索；与同名 `.jpeg` 是同一张照片的另一份源文件，不重复计为独立业务单据 |
...
54ec502d21eac86ad27882e8b0dc2b312cfb5d2b285fb6abd6592a1c29f1d9d6  Weixin Image_20260413193511_710_288.png
94478778f6b0c71825c624a346da2d579b1b625b208e07ee4f0a502e6d45d1eb  Weixin Image_20260421153105_2272_288.jpeg
244249fb3ba5b5a0575f31714c80adb280c6314ed80adf75289c4376670c7dd8  Weixin Image_20260421153105_2272_288.jpg
```
