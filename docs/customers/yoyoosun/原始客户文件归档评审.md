...
| 后续用途 | 允许落点 | 禁止事项 |
| --- | --- | --- |
| 原始资料用途登记和原件归档 | `docs/customers/yoyoosun/raw-source-files/*`、`docs/customers/yoyoosun/原始客户文件归档评审.md` 和 `docs/customers/yoyoosun/来源材料.md` | 不接 runtime，不进 docs registry，不当 Product Core |
