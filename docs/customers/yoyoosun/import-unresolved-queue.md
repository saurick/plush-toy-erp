Doc Type / 文档类型: Yoyoosun Customer Import Unresolved Queue / 永绅 yoyoosun 客户导入待确认队列
Status / 状态: Draft / 草案
...
# 永绅 yoyoosun 客户导入待确认队列 / Yoyoosun Customer Import Unresolved Queue
...
- 涉及 永绅 yoyoosun 客户特殊字段的 unresolved 不得自动进入 Product Core。
