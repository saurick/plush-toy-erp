...
| 永绅跟踪岗位投影 | 9 个业务岗位、312 条岗位权限分配、136 个去重 permission key；114 条菜单分配、29 个去重菜单 | 第 5 章逐项列全；全部应为对应 Product Core 默认角色的子集。 |
| 永绅本地有效权限 | 登记的隔离本地库已激活并读回 revision `yoyoosun-customer-package-v7.local-931c8fda75bc4b6a.runtime-v1`；10 个桌面账号、9 个手机业务岗位和管理员手机拒绝 smoke 通过 | 这是当前本地工作树的运行证据；不能外推为 133 / 生产或客户 UAT。 |
...
| 工程 `engineering` | 24 | engineering | 已审订单 | 产品 / SKU / 材料 / 工序 / BOM 齐套资料 | F02–F05、F21 | 7 |
| PMC `pmc` | 22 | pmc | 订单与工程资料 | 排期、齐套、生产评审、风险 | F02–F05、F09–F14、F21 | 11 |
