...
| 假设 | 状态 | 风险 | 处理方式 |
| --- | --- | --- | --- |
| 永绅 yoyoosun 客户流程代表毛绒玩具行业通用流程 | 未确认 | 可能把客户习惯误写进 Product Core | 先放 Industry Template Candidate |
...
| yoyoosun 需要 runtime tenant | 已否定 | 会误加 `tenant_id` 和多租户复杂度 | 当前只做客户配置包和私有化实例 |
