...
| item | value |
|---|---|
| Evidence package directory | `output/customers/yoyoosun/real-dry-run-evidence/` |
| Input source snapshot | `scripts/import/fixtures/customers/yoyoosun/source-snapshot.freeze.sample.json` |
| Input existing snapshot | `scripts/import/fixtures/customers/yoyoosun/existing-v1.freeze.sample.json` |
...
1. Review `output/customers/yoyoosun/source-snapshot-freeze/freeze-check-summary.json`.
2. Review `output/customers/yoyoosun/real-dry-run-evidence/unresolved-queue.json`.
...
`output/customers/yoyoosun/real-dry-run-evidence/` is local evidence output and is not committed to git.
