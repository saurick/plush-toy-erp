...
| Go / Review | product_skus schema、BOM 基础、purchase receipt、inventory txns / lots / balances、quality inspections |
| Draft | purchase_orders、production_orders、outsourcing_orders、customer addresses、settlement terms |
