...
本文吸收 `docs/reference/第一次20260519/毛绒玩具ERP从0到1重构方案.md` 中稳定的业务域划分，但不吸收其字段示例作为 schema 真源。任何新增表、字段、状态机、API 或页面都必须回到对应架构评审、`docs/当前真源与交接顺序.md`、`docs/product/产品完成路线图.md` 和本轮具体任务说明。
