...
| 判断架构层级、验证层级、测试形态、原型状态等治理口径 | `../当前真源与交接顺序.md` 的“项目治理口径” | `模块边界.md`、`自动化测试策略.md`、`prototypes/README.md`、`AGENTS.md` |
...
| 实施治理 | `模块实施治理.md`、`业务主链路数据流向与字段来源规则.md`、`业务数据生命周期与页面动作规则.md`、`发布门禁.md`、`迁移准备检查清单.md`、`ERP-MVP闭环验收.md` |
