...
| CAP-019       | stock_reservations                                         | Product Core           | Inventory / Shipment    |      L1-L2 | Phase 8 已开启，库存预留进入总评审范围                                                                                                                                                                                                                                                                                            | 未落 schema / runtime / API / UI；不从销售订单直接扣库存                                                                            | `docs/architecture/phase8-fact-expansion-review.md`                                                                                                                                                                                                                                                                                                           | stock-reservation-review                                 | 预留和出库易混                                                          | No             | No         |
| CAP-020       | shipments / shipment_items                                 | Product Core           | Shipment                |      L1-L2 | Phase 8 已开启，出货事实进入总评审范围                                                                                                                                                                                                                                                                                            | 未落 schema / runtime / API / UI；`shipping_released` 仍不等于 `shipped`                                                            | `docs/architecture/phase8-fact-expansion-review.md`                                                                                                                                                                                                                                                                                                           | shipment-fact-review                                     | `shipping_released != shipped`                                          | No             | No         |
| CAP-021       | shipment outbound inventory fact                           | Product Core           | Shipment / Inventory    |      L1-L2 | Phase 8 已开启，出货扣减库存事实进入总评审范围                                                                                                                                                                                                                                                                                    | 未写库存出向事实；未定义出库冲正和并发扣减                                                                                          | `docs/architecture/phase8-fact-expansion-review.md`                                                                                                                                                                                                                                                                                                           | shipment-outbound-inventory-fact-review                  | 高风险，必须单独评审                                                    | No             | No         |
| CAP-022       | AR/AP/invoice/payment/reconciliation                       | Product Core           | Finance                 |      L1-L2 | Phase 8 已开启，财务事实进入总评审范围                                                                                                                                                                                                                                                                                            | 未落 schema / runtime / API / UI；不能从放行或任务状态直接生成财务事实                                                              | `docs/architecture/phase8-fact-expansion-review.md`                                                                                                                                                                                                                                                                                                           | finance-fact-review                                      | 不能从放行直接生成财务事实                                              | No             | No         |
| CAP-023       | production facts                                           | Product Core           | Production              |      L1-L2 | Phase 8 已开启，生产事实进入总评审范围                                                                                                                                                                                                                                                                                            | 未落 schema / runtime / API / UI；不把生产任务 done 当成入库或成本事实                                                              | `docs/architecture/phase8-fact-expansion-review.md`                                                                                                                                                                                                                                                                                                           | production-fact-review                                   | 不能只靠任务状态                                                        | No             | No         |
| CAP-024       | outsourcing facts                                          | Product Core           | Outsourcing             |      L1-L2 | Phase 8 已开启，委外事实进入总评审范围                                                                                                                                                                                                                                                                                            | 未落 schema / runtime / API / UI；委外发料、回货和结算必须分开                                                                       | `docs/architecture/phase8-fact-expansion-review.md`                                                                                                                                                                                                                                                                                                           | outsourcing-fact-review                                  | 委外发料/回货/结算要分开                                                | No             | No         |
...
| yoyoosun     | 出货事实                | CAP-020             | Planned        | Phase 8 docs-only review                                                  | 已进入 Phase 8 总评审范围                                                                                                                                                                                                                                                                                                                                                          | 未落 shipments/items/outbound runtime；不等于出货放行                                      | `phase8-fact-expansion-review.md`                                                                  | 出货流程                                                               | 高风险事实层                                            |
| yoyoosun     | 库存预留                | CAP-019             | Planned        | Phase 8 docs-only review                                                  | 已进入 Phase 8 总评审范围                                                                                                                                                                                                                                                                                                                                                          | 未落 reservations runtime；不从销售订单直接扣库存                                          | `phase8-fact-expansion-review.md`                                                                  | 是否需要预留                                                           | 容易和出库混                                            |
| yoyoosun     | 财务应收 / 应付         | CAP-022             | Planned        | Phase 8 docs-only review                                                  | 已进入 Phase 8 总评审范围                                                                                                                                                                                                                                                                                                                                                          | 未落 AR/AP/invoice/payment runtime；不能从放行生成财务事实                                  | `phase8-fact-expansion-review.md`                                                                  | 对账/开票/收付款流程                                                   | 不能从放行生成                                          |
| yoyoosun     | 生产事实                | CAP-023             | Planned        | Phase 8 docs-only review                                                  | 已进入 Phase 8 总评审范围                                                                                                                                                                                                                                                                                                                                                          | 未落生产领料 / 成品入库 runtime；不把任务状态当事实                                         | `phase8-fact-expansion-review.md`                                                                  | 排产/领料流程                                                          | 不要只做状态                                            |
| yoyoosun     | 委外事实                | CAP-024             | Planned        | Phase 8 docs-only review                                                  | 已进入 Phase 8 总评审范围                                                                                                                                                                                                                                                                                                                                                          | 未落委外发料 / 回货 / 结算 runtime                                                          | `phase8-fact-expansion-review.md`                                                                  | 加工合同/外发流程                                                      | 委外合同样本需人工确认                                  |
...
-> Phase 8 fact expansion docs-only review
```
