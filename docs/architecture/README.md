...
| 任务 | 先读 | 再核对 |
| --- | --- | --- |
| 判断 Workflow / Fact 边界 | `状态工作流事实边界.md` | `../workflow/业务与协同流程地图.md`、`../product/多甲方角色能力与流程编排.md`、对应 usecase / tests |
...
| 分组 | 文档 |
| --- | --- |
| 总边界 | `状态工作流事实边界.md`、`各类流程建模边界评审.md`、`主数据源单据事实边界评审.md`、`行业专表模型评审.md` |
