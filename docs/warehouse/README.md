...
| 改库存、批次或质检事实 | `docs/architecture/主数据源单据事实边界评审.md` | Ent schema、Inventory / Quality usecase 和测试 |
| 改入库或出库协同 | `docs/architecture/状态工作流事实边界.md` | WorkflowUsecase、对应事实 usecase 和状态测试 |
